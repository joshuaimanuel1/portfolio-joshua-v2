...
// // --- KOMPONEN BARU: Word & ScrollScrubbingText ---
// const Word = ({
//   word,
//   progress,
//   range,
...
//   range: [number, number];
// }) => {
//   // Map progress scroll (0-1) ke opacity (0.2-1)
//   const opacity = useTransform(progress, range, [0.2, 1]);

//   return (
//     <motion.span style={{ opacity }} className="will-change-[opacity]">
//       {word}
//     </motion.span>
//   );
// };

// const ScrollScrubbingText = ({
//   text,
//   className,
// }: {
//   text: string;
...
//   // Membaca posisi scroll elemen relatif terhadap viewport
//   const { scrollYProgress } = useScroll({
//     target: containerRef,
//     // Animasi mulai saat elemen menyentuh 85% dari atas layar
//     // dan selesai saat menyentuh 35% dari atas layar
...
//     <div
//       ref={containerRef}
//       className={`flex flex-wrap gap-x-[0.27em] ${className || ""}`}
//     >
//       {words.map((word, i) => {
...
//       <div className="relative w-32 h-32 mx-auto mb-6 flex items-center justify-center">
//         <div
//           className={`absolute inset-0 rounded-full bg-gradient-to-tr from-[#111] to-[#222] shadow-[0_0_20px_rgba(0,0,0,0.8)] flex items-center justify-center ${
...
//             {/* BAGIAN YANG DIUPDATE MENGGUNAKAN SCROLL SCRUBBING */}
//             <ScrollScrubbingText
//               text="I've always been fascinated by how technology can transform complex problems into intuitive solutions. Currently pursuing my degree in Computer Science at BINUS University, I channel this passion into building robust and visually appealing web applications. I believe that good code goes hand-in-hand with good design, and I strive to create digital experiences that are not only functional but also delightful to use."
...
const MusicWidget = () => {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="block relative overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 shadow-xl group h-full flex flex-col items-center justify-center p-6 transition-all hover:border-slate-700/50 cursor-pointer"
    >
      <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

      <div className="relative w-40 h-40 mx-auto mb-5 flex items-center justify-center transform transition-transform duration-700 group-hover:scale-105">
        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#111] to-[#222] shadow-[0_0_20px_rgba(0,0,0,0.8)] flex items-center justify-center animate-[spin_4s_linear_infinite]">
          <div className="absolute inset-1.5 rounded-full border border-white/5"></div>
          <div className="absolute inset-3.5 rounded-full border border-white/5"></div>
          <div className="absolute inset-6 rounded-full border border-white/5"></div>
          <div className="absolute inset-8 rounded-full border border-white/5"></div>

          <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-black flex items-center justify-center relative">
            <img
              src="/assets/album-cover.jpeg"
              alt="Evergreen Love Cover"
              className="w-full h-full object-cover"
      ...
      <div className="relative z-10 w-full text-center flex flex-col items-center mt-2">
        <p className="text-slate-400 text-xs font-medium mb-1 group-hover:text-slate-300 transition-colors">
          Strings & Heart
        </p>
        ...
        <div className="w-full px-2">
          {/* Progress Bar yang jauh lebih tipis dan tanpa thumb */}
          <div className="w-full h-[2px] bg-slate-700/50 rounded-full mb-2.5 overflow-hidden">
            <div
              className="h-full bg-[#fa243c] rounded-full transition-all duration-1000 ease-linear"
              style={{ width: `${progressPercentage}%` }}
            ></div>
          </div>
          <div className="text-center text-[11px] text-slate-400 font-mono font-medium tracking-wide group-hover:text-slate-300 transition-colors">
