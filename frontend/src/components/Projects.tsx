...
export default function Projects({ projects }: { projects: Project[] }) {
  ...
  // Scroll handler — Dioptimalkan menggunakan requestAnimationFrame dan translate3d
  const handleScroll = useCallback(() => {
    ...
    animFrameRef.current = requestAnimationFrame(() => {
      ...
      // Update transform directly via DOM - Menggunakan translate3d untuk Hardware Acceleration
      const trackWidth = track.scrollWidth;
      const vw = window.innerWidth;
      const maxTranslate = Math.min(0, -(trackWidth - vw + 80));
      const newX = clamped * maxTranslate;
  ...
  // Sedikit memperpanjang scroll height per card agar user punya banyak ruang bernafas di layar sentuh
      ...
      >
        <div
          style={{
            position: "sticky",
            top: 0,
            height: "100vh", // Pakai standard vh, overflow tersembunyi
            overflow: "hidden",
            display: "flex",
            flexDirection: "column",
          }}
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                paddingBottom: "2rem",
                paddingTop: "1rem",
                // PERUBAHAN UTAMA: Hapus CSS Transition agar seirama dengan jari di layar sentuh
                willChange: "transform",
                alignItems: "stretch",
              }}
            >
